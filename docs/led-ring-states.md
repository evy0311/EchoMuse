...
| 6 | **HA idle indicator** | RGB light with device-rendered effects | 60s from the last accepted light command; interrupted by status indications | HA requests, firmware renders and expires | `em_led_light.py` |
| 7 | **Idle** | All off | — | — | — |
